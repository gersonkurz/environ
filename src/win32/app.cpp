...
// MainWindow inherits D2DWindow (frameless-window boilerplate) and adds all
...
{
    for (IDWriteTextFormat** fmt : {&m_fmtSub, &m_fmtName, &m_fmtValue,
         &m_fmtHeader, &m_fmtButton, &m_fmtMono})
    {
